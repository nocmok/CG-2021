...
public class CasteljauCurveController extends AbstractController {
    ...
    @Override public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        double step = 1e-2;
        var casteljauCurve = new CasteljauCurve(new CanvasGrid(canvas, Color.ROYALBLUE, 3), step);
        var closureDrawer = new CasteljauSpline(new CanvasGrid(canvas, Color.GREEN, 3), step);
