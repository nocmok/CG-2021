...
import com.nocmok.opengl._3d._3d.util.ObjModelLoader;
...
public class DogDemoController extends AbstractController {

    private final double modelScale = 50;
    private final double modelYShift = -100;
    private final double modelXShift = 0;
    private final XYZScale scaling = new XYZScale(modelScale, modelScale, modelScale);
    private final XYZShift shift = new XYZShift(modelXShift, modelYShift, 0);
    ...
    @Override public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        var model = ObjModelLoader.loadModel(getClass().getClassLoader().getResource("models/GermanShephardLowPoly.obj"));
        ...
        xShift.setMin(-500);
        xShift.setMax(500);
        xShift.setValue(modelXShift);

        yShift.setMin(-500);
        yShift.setMax(500);
        yShift.setValue(modelYShift);
