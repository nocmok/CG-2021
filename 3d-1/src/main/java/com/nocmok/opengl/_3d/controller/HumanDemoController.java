...
public class HumanDemoController extends AbstractController {

    private final double modelScale = 30;
    private final double modelYShift = -300;
    ...
    @Override public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        var model = ObjModelLoader.loadModel(getClass().getClassLoader().getResource("models/MaleLow.obj"));
